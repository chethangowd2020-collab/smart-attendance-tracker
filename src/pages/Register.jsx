    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center py-20 px-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-500 font-black text-[10px] uppercase tracking-[0.3em]">Join the Trackify Community</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/[0.03] border border-white/5 rounded-2xl p-4 pl-12 text-white focus:ring-2 focus:ring-purple-500/50 outline-none font-bold uppercase transition-all placeholder:text-gray-700"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Fingerprint className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-purple-400 transition-colors" size={18} />
                  <input 
                    type="text" required maxLength={10}
                    value={usn}
                    onChange={(e) => setUsn(e.target.value.toUpperCase())}
                    className="w-full bg-white/[0.03] border border-white/5 rounded-2xl p-4 pl-12 text-white focus:ring-2 focus:ring-purple-500/50 outline-none font-bold uppercase tracking-widest transition-all placeholder:text-gray-700"
        ...
        <div className="mt-10 text-center">
          <p className="text-gray-500 font-bold text-sm tracking-tight">
            ...
            <Link to="/login" className="text-white ml-2 hover:text-purple-400 transition-colors inline-flex items-center gap-2">
